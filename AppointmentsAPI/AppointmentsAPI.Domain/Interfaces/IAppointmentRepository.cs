namespace AppointmentsAPI.Domain.Interfaces
{
    public interface IAppointmentRepository
    {
        ...
        public Task<IEnumerable<Appointment>> GetByDoctorAsync(Guid doctorId, CancellationToken cancellationToken = default);
        public Task<IEnumerable<Appointment>> GetByPatientAsync(Guid patientId, CancellationToken cancellationToken = default);
